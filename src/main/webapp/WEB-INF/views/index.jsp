        ...
        <div class="masthead">
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    <h1 class="fst-italic lh-1 mb-4">거리영상기반 보행환경 설문조사</h1>
                    <p class="mb-5">거리영상기반 보행환경 설문조사 사이트의 목적은 설문참여자들이 주어진 거리영상 셋에 대한 쌍체비교 평가를 통해 정성적 DB를 구축하는 것으로, 향후 딥러닝 모델 개발 및 이를 기반으로 안전환경을 만드는 기초 데이터로 활용될 것입니다.</p>                                        
                </div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document" style="color: #000;">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p class="ls2">태스크는 2개의 거리영상셋 중에서 좀 더 걷기 좋은 영상을 선택하는 것으로 수행됩니다. 하나의 태스크는 50개의 평가영상셋과 5개의 정답이 있는 영상셋으로 구성되어있습니다. 평가자들(워커)은 55개의 영상셋을 평가하고, 그 중 5개의 정답영상에 대해 평가 적합성을 판단하여 보상을 받게됩니다. 5개의 정답영상 중 2개이상 틀릴경우, 그 태스크는 재평가를 받아야하며 재평가에 대한 평가 적합성이 유효할 경우 보상을 받을 수 있습니다.</p>
					</br>					
